...
// Package main generates RDS (Route Discovery Service) types from go-control-plane.
package main
...
func buildTypeRegistry() map[string]reflect.Type {
	...
	typesToScan := []interface{}{
		...
		route.Route{},
		route.RouteMatch{},
		route.RouteMatch_ConnectMatcher{},
		route.RouteMatch_GrpcRouteMatchOptions{},
		route.RouteMatch_TlsContextMatchOptions{},
		route.RouteAction{},
		...
		route.RetryPolicy{},
		route.RetryPolicy_RetryBackOff{},
		route.RetryPolicy_RetryHostPredicate{},
		route.RetryPolicy_RetryPriority{},
		route.HedgePolicy{},
		route.CorsPolicy{},
		route.Tracing{},
		...
		route.RateLimit_Action_SourceCluster{},
		route.RateLimit_Action_DestinationCluster{},
		route.RateLimit_Action_RequestHeaders{},
		route.RateLimit_Action_RemoteAddress{},
		route.RateLimit_Action_GenericKey{},
		route.RateLimit_Action_HeaderValueMatch{},
		route.RateLimit_Action_DynamicMetaData{},
		route.RateLimit_Action_MetaData{},
		route.RateLimit_Action_MaskedRemoteAddress{},
		route.RateLimit_Action_QueryParameterValueMatch{},
		route.RateLimit_Action_QueryParameters{},
		route.RateLimit_Override{},
		route.RateLimit_Override_DynamicMetadata{},
		route.RouteAction_HashPolicy{},
		route.RouteAction_HashPolicy_Header{},
		route.RouteAction_HashPolicy_Cookie{},
		route.RouteAction_HashPolicy_ConnectionProperties{},
		route.RouteAction_HashPolicy_QueryParameter{},
		route.RouteAction_HashPolicy_FilterState{},
		route.RouteAction_RequestMirrorPolicy{},
		route.RouteAction_UpgradeConfig{},
		route.RouteAction_MaxStreamDuration{},
		route.HeaderMatcher{},
		route.QueryParameterMatcher{},
		route.InternalRedirectPolicy{},
		route.Decorator{},
		route.ClusterSpecifierPlugin{},
		route.Vhds{},
		// Matcher types
...
var (
	outputDir = flag.String("output", "pkg/xds/types/rds", "Output directory")
...
func main() {
	...
	fmt.Printf("Successfully generated RDS types in %s\n", *outputDir)
}
...
func (g *Generator) Generate() error {
	...
	// Start with the RouteConfiguration type
	routeType := reflect.TypeOf(route.RouteConfiguration{})
	g.queueType(routeType, "RDS")
...
func (g *Generator) fetchEnumDefinitions() {
	...
	// Also add matcher packages explicitly
	fetchedPkgs["envoy/type/matcher/v3"] = true
...
func (g *Generator) writeOutput() error {
	...
	buf.WriteString("// Code generated by tools/typegen/rds. DO NOT EDIT.\n")
	buf.WriteString("// Source: github.com/envoyproxy/go-control-plane/envoy/config/route/v3\n")
	buf.WriteString(fmt.Sprintf("// Envoy version: %s\n", g.envoyTag))
	buf.WriteString("// To regenerate: make generate-rds\n\n")
	buf.WriteString("package rds\n\n")
	...
	for i, name := range typeNames {
		if name == "RDS" {
			typeNames = append([]string{"RDS"}, append(typeNames[:i], typeNames[i+1:]...)...)
			break
		}
	}
	...
	filename := filepath.Join(g.outputDir, "rds_generated.go")
