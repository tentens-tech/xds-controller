...
// Package main generates LDS (Listener Discovery Service) types from go-control-plane.
package main
...
func buildTypeRegistry() map[string]reflect.Type {
	...
	typesToScan := []interface{}{
		...
		core.CidrRange{},
		core.DataSource{},
		// Listener package types
		listener.Listener{},
		listener.Listener_InternalListenerConfig{},
		listener.Listener_ConnectionBalanceConfig{},
		listener.Listener_ConnectionBalanceConfig_ExactBalance{},
		listener.Listener_DeprecatedV1{},
		listener.FilterChain{},
		listener.FilterChainMatch{},
		listener.Filter{},
		listener.ListenerFilter{},
		listener.ListenerFilterChainMatchPredicate{},
		listener.ListenerFilterChainMatchPredicate_MatchSet{},
		listener.QuicProtocolOptions{},
		listener.UdpListenerConfig{},
		// AccessLog package types
		accesslog.AccessLog{},
...
var (
	outputDir = flag.String("output", "pkg/xds/types/lds", "Output directory")
...
func main() {
	...
	fmt.Printf("Successfully generated LDS types in %s\n", *outputDir)
}
...
func (g *Generator) Generate() error {
	...
	// Start with the Listener type
	listenerType := reflect.TypeOf(listener.Listener{})
	g.queueType(listenerType, "LDS")
...
func (g *Generator) writeOutput() error {
	...
	buf.WriteString("// Code generated by tools/typegen/lds. DO NOT EDIT.\n")
	buf.WriteString("// Source: github.com/envoyproxy/go-control-plane/envoy/config/listener/v3\n")
	buf.WriteString(fmt.Sprintf("// Envoy version: %s\n", g.envoyTag))
	buf.WriteString("// To regenerate: make generate-lds\n\n")
	buf.WriteString("package lds\n\n")
	...
	for i, name := range typeNames {
		if name == "LDS" {
			typeNames = append([]string{"LDS"}, append(typeNames[:i], typeNames[i+1:]...)...)
			break
		}
	}
	...
	filename := filepath.Join(g.outputDir, "lds_generated.go")
