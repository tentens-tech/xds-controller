...
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  With Let's Encrypt Challenge:                                   │
│    1. Vault (if configured in resource or global)               │
│    2. Kubernetes Secrets (default fallback)                      │
│                                                                  │
│  Without Challenge (Self-signed):                                │
│    1. Kubernetes (if kubernetes_config specified)               │
│    2. Local (if local_config.path specified)                    │
│    3. Kubernetes (if K8s client available)                       │
...
📚 **Full list of supported DNS providers:** [lego DNS Providers Documentation](https://go-acme.github.io/lego/dns/)
